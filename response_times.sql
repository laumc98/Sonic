...
WHERE opportunity_candidates.interested is not null AND utm_medium IN ('ja_mtc','ja_rlvsgl_prs','ja_allsgl_prs','ja_rlvsgl_org','ja_allsgl_org','rc_cb_rcdt','rc_ccg','rc_syn','rc_src','am_sug','srh_jobs','sml_jobs','am_inv','google_jobs','fb_jobs','ref_ts','shr_ts','ro_sug','pr_sml_jobs','rc_trrx_inv','syn','src','ref_ptn','ref_cdt','ref_vst_imp','syn_rqt','trr_webinars')
