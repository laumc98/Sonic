/* AA : Sonic : similar jobs clicks: prod */ 
SELECT
      "atomic"."com_torrelabs_similar_opportunity_clicked_1"."opportunity_id" AS "Alfa ID",
      count(*) as "sml_jobs_clicks"
FROM
...
GROUP BY
      "atomic"."com_torrelabs_similar_opportunity_clicked_1"."opportunity_id"